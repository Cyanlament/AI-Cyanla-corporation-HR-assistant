...
bool DatabaseManager::createTables()
{
    ...
    if (!isUsernameExists("admin")) {
        registerUser("admin", "admin123", "admin@Cyanla.com", "", "管理员", "系统管理员");
    }
    
    // 创建测试客服账户
    if (!isUsernameExists("staff1")) {
        registerUser("staff1", "123456", "staff1@Cyanla.com", "", "客服", "客服小王");
    }
    if (!isUsernameExists("staff2")) {
        registerUser("staff2", "123456", "staff2@Cyanla.com", "", "客服", "客服小李");
    }
