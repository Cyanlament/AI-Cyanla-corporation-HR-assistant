...
void RecordWidget::loadRecords()
{
    ...
    // 模拟数据
    m_recordData.append({"U001", "hanser", "如何预约面试？", "您可以通过官方微信...", "已回复", "2025-08-15 09:30", "面试预约"});
    m_recordData.append({"U002", "yousa", "公司在哪里？", "我司地址位于...", "已回复", "2025-08-19 10:15", "公司信息"});
    m_recordData.append({"U003", "血狼破军", "丰川祥子你什么杯啊？", "", "未回复", "2025-08-22 11:00", "其他服务"});
    m_recordData.append({"U004", "上级", "医保怎么报销？", "正在处理中...", "处理中", "2025-08-30 14:20", "医保报销"});
    m_recordData.append({"U005", "白发", "安保部新啤酒收费标准？", "收费标准为...", "已回复", "2025-09-02 16:45", "其他服务"});
